        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="container">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/guru/simpan_mapel" method="post">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="KodeMapel">Kode Mata Pelajaran</label>
                                <input type="text" class="form-control" name="kode" id="inputKodeMapel" required="required"  placeholder="EL0123">
                            </div>
                            <div class="form-group">
                                <label for="NamaMapel">Nama Mata Pelajaran</label>
                                <input type="text" class="form-control" name="nama" id="inputNamaMapel" required="required" placeholder="Teknik Digital">
                            </div>
                            <div class="form-group">
                                <label for="DurasiBelajar">Durasi Belajar</label>
                                <input type="text" class="form-control" name="durasi" id="inputDurasiBelajar" required="required"  placeholder="50 menit">
                            </div>
                            <button class="btn btn-outline-primary" type="submit">Tambah Mata Pelajaran</button>
